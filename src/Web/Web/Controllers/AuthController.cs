...
namespace Web.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        private async Task<LoginResponseViewModel> GerarJwt(string email)
        {
            ...
            // Adiciona as Claims do Token
            claims.Add(new Claim(JwtRegisteredClaimNames.Sub, user.Id));
            claims.Add(new Claim(JwtRegisteredClaimNames.Email, user.Email));
            claims.Add(new Claim(JwtRegisteredClaimNames.Jti, Guid.NewGuid().ToString()));
            claims.Add(new Claim(JwtRegisteredClaimNames.Nbf, ToUnitxEpochDate(DateTime.UtcNow).ToString()));
            claims.Add(new Claim(JwtRegisteredClaimNames.Nbf, ToUnitxEpochDate(DateTime.UtcNow).ToString(), ClaimValueTypes.Integer64));

            //Laço que adiciona as roles
        ...
        private static long ToUnitxEpochDate(DateTime date)
